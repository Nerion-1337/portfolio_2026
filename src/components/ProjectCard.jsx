...
const ProjectCard = ({ project }) => {
  ...
  return (
    <div className="group relative flex flex-col h-full bg-gray-900 rounded-xl overflow-hidden border border-gray-800 shadow-2xl transform-gpu subpixel-antialiased">
      ...
      <div className="relative h-48 overflow-hidden bg-gray-900 border-b border-gray-800">
        ...
        <img
          ...
          onError={(e) => { e.target.style.display = 'none'; e.target.parentNode.style.backgroundColor = '#1f2937'; }} 
        />
